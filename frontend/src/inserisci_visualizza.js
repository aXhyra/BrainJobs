...
function campo_vis_singola(identificatore, utente) {
    ...
    $.ajax({
        ...
        success: function (response) {
            var stringa = "<select id='" + identificatore + "_option'>";
    ...
    $.ajax({
        ...
        success: function (response) {
            if ((location.href).includes("visualizza_job_specifico_utente_specifico.html")) {
                ...
                var stringa = "<select id='" + identificatore + "_option' onchange=" + variabile +">";
...
function metodo_visualizza(response) {
    var string_tab = "";
    for (var x in response) {
        string_tab += "<div class='div_visualizza'><label>jobid: </label>" +
...
function metodo_visualizza_singolo(response) {
    var stringa = "<div class='div_visualizza'><label>job_id: </label>" +
